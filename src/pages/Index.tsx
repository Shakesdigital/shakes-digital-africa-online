          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="text-center">
                ...
                <p className="text-gray-600">Deep understanding of African business challenges and sustainable Sustainable African Business Development needs to create competitive, contextually relevant solutions</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We partner with African businesses to understand competitive challenges and sustainable Sustainable African Business Development needs, implement innovative solutions, and measure outcomes for scalability across African markets while contributing to economic resilience.
                </p>
