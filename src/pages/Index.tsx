            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We partner with African businesses to understand competitive challenges and Sustainable African Business Development needs, implement innovative solutions, and measure outcomes for scalability across African markets while contributing to economic resilience.
                </p>
