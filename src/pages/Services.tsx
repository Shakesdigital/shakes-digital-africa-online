            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Purpose-built services addressing African business challenges and Sustainable African Business Development needs—revenue growth, operational efficiency, market expansion, and competitive advantage through contextually-relevant digital technology that supports long-term business viability.
                </p>
              </div>
              <div>
                <img
