            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
              ...
              <div className="w-full lg:w-3/5 text-gray-700">
                ...
                <div className="space-y-5 leading-relaxed">
                  ...
                  <p>This conviction in technology's transformative potential inspired me to found Shakes Digital Agency in late 2024. With the rise of Artificial Intelligence (AI), I am committed to harnessing its capabilities to tackle Sustainable African Business Development challenges, scale impact, and drive community-wide economic advancement out of poverty.</p>
