            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
              ...
              <div className="w-full lg:w-3/5 text-gray-700">
                ...
                <div className="space-y-5 leading-relaxed">
                  ...
                  <p>This conviction in technology's transformative potential inspired me to found Shakes Digital Agency in late 2024. We deliver research-driven, custom software, web and mobile applications, and SaaS solutions tailored to Africa's unique business obstacles and sustainable business challenges—from optimizing agricultural supply chains and smart farming operations to enabling SME e-commerce, developing tools for NGOs, and supporting resilient business models. Employing human-centered design and Design Thinking principles, we build scalable, inclusive platforms that foster sustainable business development and long-term economic viability for African enterprises.</p>
                  <p>With the rise of Artificial Intelligence (AI), I am committed to harnessing its capabilities to tackle Sustainable African Business Development challenges, scale impact, and drive community-wide economic advancement out of poverty.</p>
