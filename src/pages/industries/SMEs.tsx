    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Custom Software, Websites & Mobile Apps for SME Growth Across Africa</h1>
                <p className="text-xl text-blue-100 mb-8">We build custom business software, websites, and mobile apps that help small and medium enterprises establish online presence, reach customers, streamline operations, and scale across Africa's growing markets.</p>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm text-white">Revenue Growth with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Why Custom Software, Websites & Mobile Apps for African SMEs?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Africa's SMEs need custom software to streamline operations, professional websites to build credibility, and mobile apps to serve customers on-the-go, the foundation for competing in the digital economy.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              { icon: TrendingUp, color: "shakes-teal", title: "Sales & CRM Software Portals", desc: "Custom software tools for managing customer relationships, tracking sales pipelines, and automating follow-ups, professionalizing SME sales processes." },
              { icon: BarChart, color: "shakes-blue", title: "Business Analytics Dashboards", desc: "Custom software dashboards tracking sales, customer patterns, inventory, and financial performance, enabling data-driven decisions for SME owners." },
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Custom Software, Website & Mobile App Solutions for SMEs</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From retail shops to service providers, manufacturers to tech startups, we build custom software, websites, and mobile apps that drive SME growth across Africa.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-6">Custom software tools for inventory management, employee scheduling, financial tracking, and supplier management, bringing operational efficiency to SMEs.</p>
                <ul className="space-y-3">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Our Custom Software, Website & Mobile App Development Approach for SMEs</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">We research your business model and customer journey, then build custom software, websites, and mobile apps that drive growth and operational efficiency.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              { n: "2", c: "bg-shakes-blue", t: "Build", d: "Developing your business software platform, website, and customer engagement mobile app" },
            ...
            <div className="bg-gradient-to-br from-shakes-blue to-shakes-teal text-white rounded-2xl p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">A Business Software Platform, Website & Mobile App Driving 70% Revenue Growth</h2>
                  <p className="text-xl text-blue-100 mb-8">We can build a professional software platform, website, and customer engagement app that increases your revenue by 70%, expands your customer base 3x, and establishes your SME as a market leader in your region.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Custom Software, a Website, or a Mobile App for Your SME?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Let's build a business software platform, professional website, or customer engagement mobile app that drives growth, increases revenue, and scales your business across Africa.</p>
