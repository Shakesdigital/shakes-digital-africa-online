    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Custom Software, Websites & Mobile Apps for Healthcare Access Across Africa</h1>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm text-white">Patient Reach with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Why Custom Software, Websites & Mobile Apps for Africa's Healthcare Sector?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Africa's healthcare providers need custom software for records and clinic operations, websites for patient acquisition, and mobile apps for telemedicine and patient engagement, expanding access to quality care across the continent.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              { icon: Shield, color: "shakes-blue-light", title: "Patient Portal Software", desc: "Custom software portals for medical records access, lab results, appointment history, billing, and secure messaging with healthcare providers." },
              ...
              { icon: BarChart, color: "shakes-blue", title: "Health Analytics Dashboards", desc: "Custom software dashboards tracking patient volumes, disease patterns, resource utilization, and facility performance for data-driven healthcare management." },
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Custom Software, Website & Mobile App Solutions for Healthcare</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From clinics to hospitals, health NGOs to pharma companies, we build custom software, websites, and mobile apps that improve healthcare delivery across Africa.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Patient Records Software Portals</h3>
                <p className="text-gray-600 mb-6">Custom electronic medical records software platforms for clinics and hospitals, patient data management, lab results, treatment history, and billing.</p>
                <ul className="space-y-3">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Our Custom Software, Website & Mobile App Development Approach for Healthcare</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">We research your healthcare challenges, then build custom software, websites, and mobile apps that expand patient access and improve care delivery.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              { n: "2", c: "bg-shakes-blue", t: "Build", d: "Developing your healthcare software platform, website, and telemedicine mobile app with HIPAA-compliant security" },
            ...
            <div className="bg-gradient-to-br from-shakes-blue to-shakes-teal text-white rounded-2xl p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">A Healthcare Software Platform, Website & Telemedicine App Serving 50K+ Patients</h2>
                  <p className="text-xl text-blue-100 mb-8">We can build a healthcare software platform, website, and telemedicine mobile app that serves 50,000+ patients, reduces wait times by 70%, and expands healthcare access to remote communities across Africa.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Custom Software, a Website, or a Mobile App for Your Healthcare Organization?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Let's build a healthcare software platform, website, or telemedicine app that expands patient access, improves care delivery, and grows your practice across Africa.</p>
