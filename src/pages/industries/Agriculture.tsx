  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                  Custom Software, Websites & Mobile Apps for Agricultural Business Growth Across Africa
                </h1>
                <p className="text-xl text-blue-100 mb-8">
                  We build custom software, websites, and mobile applications that help agribusinesses access markets, manage operations, connect with buyers, and boost profitability across Africa's agricultural landscape.
                </p>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm">Revenue Growth Potential with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Why Custom Software, Websites & Mobile Apps for Agriculture */}
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">
                Why Custom Software, Websites & Mobile Apps for Africa's Agribusiness Growth?
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Africa's agribusinesses need strong online presence and mobile tools to compete globally. Our custom software, websites, and mobile apps address market access gaps, supply chain inefficiencies, and operational challenges, driving productivity, profitability, and market expansion.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-shakes-blue-dark mb-4">Supply Chain Software Portals</h3>
                <p className="text-gray-600">
                  Custom software platforms for tracking products from farm to market, ensuring quality, reducing losses, enabling traceability, and building consumer trust in African agricultural products.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600">
                  Custom software dashboards for plot mapping, input tracking, labor management, financial records, and harvest planning, professionalizing smallholder agriculture.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Custom Software, Website & Mobile App Solutions for Agriculture */}
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">
                Custom Software, Website & Mobile App Solutions for Agricultural Business Growth
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From agribusinesses to cooperatives, processors to exporters, we build custom software, websites, and mobile apps that optimize every link in Africa's agricultural value chain.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Farm Management Software Dashboards</h3>
                <p className="text-gray-600 mb-6">
                  Custom software platforms for managing farm operations, plot mapping, input tracking, labor management, financial records, and harvest planning for improved productivity.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-shakes-teal flex-shrink-0 mt-1" />
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-6">
                  Custom track-and-trace software platforms ensuring product quality, reducing post-harvest losses, and building transparency from farm to consumer for premium market access.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-shakes-teal flex-shrink-0 mt-1" />
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Cooperative Management Software Portals</h3>
                <p className="text-gray-600 mb-6">
                  Custom software tools for farmer cooperatives, member management, input distribution, aggregated marketing, financial services, and governance portals.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-shakes-teal flex-shrink-0 mt-1" />
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">
                Our Custom Software, Website & Mobile App Development Approach for Agriculture
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We research your agricultural challenges, then build custom software, websites, and mobile apps that drive profitability and market access for African agribusinesses.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    A Marketplace Software Platform, Website & Mobile App Driving 35% Agricultural Revenue Growth
                  </h2>
                  <p className="text-xl text-blue-100 mb-8">
                    We can build an integrated marketplace software platform, website, and farmer advisory mobile app, potentially achieving 35% revenue increases, premium market prices, reduced losses, and market leadership for thousands of agricultural enterprises.
                  </p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Ready to Build Custom Software, a Website, or a Mobile App for Your Agricultural Business?
              </h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Let's build a software platform, website, or mobile app that boosts your market access, increases profitability, and helps your agribusiness grow across Africa.
              </p>
