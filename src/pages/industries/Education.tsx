    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Custom Software, Websites & Mobile Apps for Education Access Across Africa</h1>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm text-white">Student Reach with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Why Custom Software, Websites & Mobile Apps for Africa's Education Sector?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Africa's educational institutions need custom software for learning management and administration, websites for visibility and enrollment, and mobile apps for delivering learning content to students anywhere, bridging the education access gap with technology.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              { icon: BookOpen, color: "shakes-blue-light", title: "Learning Management Software Platforms", desc: "Custom learning management software platforms with course creation, student tracking, assessments, and certificate generation." },
              ...
              { icon: BarChart, color: "shakes-blue", title: "Education Analytics Dashboards", desc: "Custom software dashboards tracking student performance, enrollment trends, completion rates, and institutional KPIs for data-driven decisions." },
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Custom Software, Website & Mobile App Solutions for Education</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From schools to universities, training centers to EdTech startups, we build custom software, websites, and mobile apps that transform education delivery across Africa.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Learning Management System (LMS) Websites</h3>
                <p className="text-gray-600 mb-6">Custom software platforms for course creation, student enrollment, content delivery, assessments, grading, and certificate generation.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Our Custom Software, Website & Mobile App Development Approach for Education</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">We research your educational challenges, then build custom software, websites, and mobile apps that expand access and improve learning outcomes.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              { n: "2", c: "bg-shakes-blue", t: "Build", d: "Developing your education software platform, website, and mobile learning app with offline capabilities" },
            ...
            <div className="bg-gradient-to-br from-shakes-blue to-shakes-teal text-white rounded-2xl p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">An Education Software Platform, Website & Mobile App Reaching 100K+ Students</h2>
                  <p className="text-xl text-blue-100 mb-8">We can build an education software platform, website, and mobile learning app that reaches 100,000+ students, improves completion rates by 60%, and delivers quality education to underserved communities.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Custom Software, a Website, or a Mobile App for Your Educational Institution?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Let's build an e-learning software platform, website, or mobile app that expands access, engages students, and transforms education delivery across Africa.</p>
