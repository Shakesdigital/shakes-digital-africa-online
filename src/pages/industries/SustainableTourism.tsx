    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                  Custom Software, Websites & Mobile Apps for Tourism Business Growth Across Africa
                </h1>
                <p className="text-xl text-blue-100 mb-8">
                  We build tourism management software, booking websites, and guest experience mobile apps that help tourism operators grow bookings, manage operations, and deliver exceptional visitor experiences across Africa.
                </p>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm text-white">Booking Growth with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Why Custom Software, Websites & Mobile Apps for Africa's Tourism Sector?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Africa's tourism operators need professional booking websites and guest experience mobile apps to compete globally. Our custom software manages operations, our websites drive direct bookings, and our mobile apps enhance visitor experiences, growing revenue while supporting community empowerment.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-shakes-blue-dark mb-4">Conservation Software Portals</h3>
                <p className="text-gray-600">Custom software dashboards monitoring environmental impact, wildlife populations, and visitor capacity, ensuring tourism supports fragile ecosystems.</p>
              </div>
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-shakes-blue-dark mb-4">Analytics Software Dashboards</h3>
                <p className="text-gray-600">Custom software dashboards tracking bookings, visitor patterns, revenue, and seasonal trends, enabling smarter business decisions for sustainable growth.</p>
              </div>
              <div className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow">
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Custom Software, Website & Mobile App Solutions for Tourism Operators</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From safari lodges to hospitality ventures, we build custom software, websites, and mobile apps that drive bookings and empower communities.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Operations Management Software Portals</h3>
                <p className="text-gray-600 mb-6">Custom operations management software for lodge operations, staff scheduling, inventory management, and guest services.</p>
                <ul className="space-y-3">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Our Custom Software, Website & Mobile App Development Approach for Tourism</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">We research your tourism operation, then build custom software, websites, and mobile apps that drive bookings and enhance guest experiences.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              { n: "2", c: "bg-shakes-blue", t: "Build", d: "Developing your tourism operations software, booking website, and guest experience mobile app" },
            ...
            <div className="bg-gradient-to-br from-shakes-blue to-shakes-teal text-white rounded-2xl p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">A Tourism Operations Software Platform, Booking Website & Guest App Doubling Direct Bookings</h2>
                  <p className="text-xl text-blue-100 mb-8">We can build a tourism operations software platform, booking website, and guest experience mobile app that doubles your direct bookings, increases operational efficiency by 40%, and empowers 120+ community members.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Custom Software, a Website, or a Mobile App for Your Tourism Business?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Let's build a tourism operations software platform, booking website, or guest experience mobile app that drives bookings, increases revenue, and enhances visitor experiences across Africa.</p>
