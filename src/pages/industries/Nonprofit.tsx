    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Custom Software, Websites & Mobile Apps for Non-Profit Impact Across Africa</h1>
                <p className="text-xl text-blue-100 mb-8">We build custom software, websites, and mobile apps that help non-profits and NGOs amplify their mission, increase donations, manage programs, measure impact, and engage communities across Africa.</p>
              ...
              <div className="relative animate-fade-in">
                ...
                <div className="absolute -bottom-6 -left-6 bg-shakes-blue-dark text-white p-6 rounded-lg shadow-xl max-w-xs">
                  ...
                  <p className="text-sm text-white">Donation Growth with Software, Website & Mobile App</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Why Custom Software, Websites & Mobile Apps for African Non-Profits?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">African non-profits need custom software to manage programs and measure impact, compelling websites to attract donors, and mobile apps for field data collection and community engagement, maximizing impact with limited resources.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              { icon: BarChart, color: "shakes-blue", title: "Impact Dashboard Software", desc: "Custom software dashboards displaying program outcomes, beneficiary data, financial transparency, and impact metrics, building donor confidence." },
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Custom Software, Website & Mobile App Solutions for Non-Profits</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From international NGOs to community-based organizations, we build custom software, websites, and mobile apps that amplify your mission and accelerate your impact across Africa.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Program Management Software Portals</h3>
                <p className="text-gray-600 mb-6">Custom software platforms for program planning, implementation tracking, budget management, staff coordination, and donor reporting.</p>
                <ul className="space-y-3">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-shakes-blue-dark mb-4">Impact Measurement Software Dashboards</h3>
                <p className="text-gray-600 mb-6">Custom software dashboards visualizing program outcomes, beneficiary data, KPIs, and impact stories, building donor confidence and supporting grant applications.</p>
                <ul className="space-y-3">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-shakes-blue-dark mb-6">Our Custom Software, Website & Mobile App Development Approach for Non-Profits</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">We research your mission and programs, then build custom software, websites, and mobile apps that amplify your impact and strengthen your donor relationships.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-shakes-blue to-shakes-teal text-white rounded-2xl p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">A Program Management Software Platform, Fundraising Website & Field App Reaching 200K+ Beneficiaries</h2>
                  <p className="text-xl text-blue-100 mb-8">We can build a program management software platform, fundraising website, and field data collection app that increases donations by 150%, reaches 200,000+ beneficiaries, and provides real-time impact measurement across your programs.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <div className="bg-gradient-to-r from-shakes-teal to-shakes-blue text-white rounded-2xl p-12 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Custom Software, a Website, or a Mobile App for Your Non-Profit?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Let's build a program management software platform, fundraising website, or field data collection app that amplifies your mission, increases donations, and maximizes your impact across Africa.</p>
