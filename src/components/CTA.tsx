      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto text-gray-700">
            We're committed to leveraging digital technology through our core services. Our objectives—research, implementation, partnerships, resource mobilization, and evaluation—ensure every solution drives sustainable outcomes for your organization.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-2xl font-bold text-shakes-teal mb-3">Research & Implementation</h3>
              <p className="text-gray-600">Identifying sustainable challenges and deploying tailored Custom Software, Web, and Mobile solutions.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <section className="py-20 bg-gradient-to-r from-shakes-blue to-shakes-blue-dark text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Let's create innovative digital solutions—Custom Software, Web Development, or Mobile Apps—that address your sustainable community and business challenges worldwide.
          </p>
