...
const SEOSchema: React.FC<SEOSchemaProps> = ({
  ...
  const organizationSchema = {
    ...
    "image": "https://shakesdigital.com/hero-mobile-app.png",
    "description": "Africa's #1 digital agency specializing in offline-ready Progressive Web Apps (PWAs), custom software, and mobile applications optimized for low-bandwidth environments",
    "founder": {
      "@type": "Person",
      "@id": "https://shakesdigital.com/#founder",
      "name": "Dan Mugisa Byenkya",
      "jobTitle": "Founder & Digital Innovation Expert",
      "description": "Expert in offline-first architectures and African market digital solutions",
    ...
    "offers": {
      ...
      "priceCurrency": "USD",
      "description": "Custom software development, PWAs, and mobile applications"
    },
    "sameAs": [
  ...
  const serviceSchema = type === 'Service' ? {
    ...
    "serviceType": "Digital Web Development",
    "audience": {
      "@type": "Audience",
      "audienceType": "African Businesses, Startups, NGOs, Educational Institutions"
    },
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
