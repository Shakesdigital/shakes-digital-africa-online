      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="relative">
              ...
              <img
                ...
                alt="Shakes Digital Team building custom software, websites, and mobile apps"
          ...
          <div>
            ...
            <p className="text-lg font-medium mb-2 text-shakes-teal">Building Custom Software, Websites & Mobile Apps for Africa's Future</p>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold mb-3 text-shakes-blue-dark">Founder's Story</h3>
                <p className="text-gray-600 mb-4">
                  I started Shakes Digital with a clear mission: to develop custom software, websites, and mobile applications that solve real African Development Business Challenges. During my time as Program Coordinator at FSD (now known as FOSCOD) in Uganda, one question kept echoing in my mind:
                </p>
                <p className="text-gray-600 mb-4 font-medium italic">
                  "How can we build software, websites, and mobile apps that directly address the business and development challenges holding Africa's communities and enterprises back?"
                </p>
                <p className="text-gray-600 mb-4">
                  This question inspired the creation of Shakes Digital. We develop custom software, websites, and mobile applications that directly tackle these challenges, helping African businesses establish their digital presence, reach more customers, automate operations, and scale across markets. Our goal is to leverage practical digital product development to meet African Development Business Challenges, creating pathways for growth, inclusion, and sustainability.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  At Shakes Digital, we are dedicated to developing custom software, websites, and mobile applications that empower African businesses and development organizations. By focusing on these practical digital tools, we aim to help African enterprises establish digital presence, acquire customers, improve operations, and drive long-term sustainable growth across the continent.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold mb-3 text-shakes-teal">Our Objectives</h3>
                <p className="text-gray-600 mb-4">At Shakes Digital, our objectives drive every custom software, website, and mobile app project we undertake:</p>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-shakes-teal rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-shakes-blue-dark mb-1">Software, Website & App Development</h4>
                      <p className="text-gray-600 text-sm">Design and develop high-quality custom software, websites, and mobile applications tailored to solve specific African Development Business Challenges, from e-commerce and customer engagement to operations management and market expansion.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-shakes-teal rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Partner with local and international organizations to expand the reach and impact of our software, website, and mobile app solutions across African markets.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-shakes-teal rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Build software, websites, and mobile apps that are accessible, user-friendly, and designed to bridge the digital divide for African communities and businesses.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-shakes-teal rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Continuously monitor and evaluate the business impact of our software, websites, and mobile apps, optimizing for scalability and real-world results across diverse African populations.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-600">We envision an Africa where every business and development organization has access to professionally built software, websites, and mobile applications that drive growth, solve challenges, and contribute to the continent's economic transformation.</p>
              </div>
