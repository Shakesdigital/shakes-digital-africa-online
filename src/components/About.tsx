        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 text-gray-600">
              Founded with a vision to transform Africa's digital landscape, Shakes Digital 
              brings together the region's best tech talent to deliver innovative solutions that drive growth.
            </p>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold mb-2 text-shakes-teal">Our Mission</h3>
                <p className="text-gray-600">
                  To empower African businesses and organizations with transformative digital solutions 
                  that are innovative, scalable, and tailored to local needs.
                </p>
              </div>
              
              <div>
                <h3 className="text-xl font-bold mb-2 text-shakes-teal">Our Expertise</h3>
                <p className="text-gray-600">
                  Our team combines deep technical knowledge with local insights to create digital experiences 
                  that resonate with African users while meeting international standards.
                </p>
              </div>
              
              <div>
                <h3 className="text-xl font-bold mb-2 text-shakes-teal">Our Commitment</h3>
                <p className="text-gray-600">
                  We're committed to delivering excellence, fostering innovation, and building long-term partnerships 
                  that contribute to Africa's digital transformation journey.
                </p>
              </div>
            </div>
          </div>
